...
{{--    <link rel="stylesheet" href="{{asset('/public/admin')}}/ckeditor/samples/css/samples.css">--}}
    <link rel="stylesheet" href="{{asset('/public/admin')}}/samples/toolbarconfigurator/lib/codemirror/neo.css">
</head>
